...
function App() {
  ...
  return (
   ...
   <div className="w-[100vw] h-[100vh] flex justify-center items-center bg-[#030303]
    gap-10 flex-col">  
     
     <div className="text-[#4accff] font-medium text-3xl">Increment & Decrement </div>
    ...
    <button onClick={resetHandler} className="bg-[#4791ff] text-white px-5 py-2 rounded-sm text-lg">
        Reset
    </button>
